-- Function to calculate total unique opportunities count (no duplicates for national opportunities)
...
-- Function to calculate total funding available with state filtering
