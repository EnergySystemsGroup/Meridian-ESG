-- Fix UUID comparison in get_funding_opportunities_dynamic_sort function
...
BEGIN
    ...
    -- Add filter for tracked IDs - properly cast text to UUID
    ...
    RAISE NOTICE 'Executing query (V7): %', final_query;
