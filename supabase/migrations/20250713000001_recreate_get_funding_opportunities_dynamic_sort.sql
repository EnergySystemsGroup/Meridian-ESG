-- Migration: Recreate get_funding_opportunities_dynamic_sort function
-- This migration recreates the function that was dropped in 20250710000001_migrate_to_api_opportunity_id.sql
-- The function is updated to work with the current database schema after the field renaming migrations
...
BEGIN
    ...
    RAISE NOTICE 'Executing query (V9 - recreated after schema migration): %', final_query; -- Updated version notice
...
COMMENT ON FUNCTION get_funding_opportunities_dynamic_sort(TEXT, TEXT[], TEXT[], TEXT, TEXT, TEXT, INT, INT, TEXT[]) IS 'Get funding opportunities with dynamic sorting and filtering - recreated after api_opportunity_id migration';