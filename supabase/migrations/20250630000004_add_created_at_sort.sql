-- Add created_at sorting to get_funding_opportunities_dynamic_sort function
...
BEGIN
    ...
    RAISE NOTICE 'Executing query (V8 - created_at sort added): %', final_query; -- Updated version notice
...
COMMENT ON FUNCTION get_funding_opportunities_dynamic_sort(TEXT, TEXT[], TEXT[], TEXT, TEXT, TEXT, INT, INT, TEXT[]) IS 'Get funding opportunities with dynamic sorting and filtering, including created_at sorting'; 