-- Migration: Fix tracked IDs edge cases for empty strings and arrays
-- Handle edge cases with tracked IDs parameter
...
BEGIN
    ...
    RAISE NOTICE 'Executing query (V11 - fixed edge cases): %', final_query;
...
COMMENT ON FUNCTION get_funding_opportunities_dynamic_sort(TEXT, TEXT[], TEXT[], TEXT, TEXT, TEXT, INT, INT, TEXT[]) IS 'Get funding opportunities with dynamic sorting and filtering - fixed edge cases for empty tracked IDs';