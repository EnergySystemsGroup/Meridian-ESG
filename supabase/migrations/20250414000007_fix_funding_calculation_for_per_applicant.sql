-- Create a new function for per-applicant funding calculation
...
-- Update the API function to use the per-applicant function by default
...
BEGIN
    -- Just use the per-applicant function
