-- Correcting the filtering logic for award amounts based on exact requirements
...
BEGIN
    ...
    WHERE
        ...
        -- 1. Include ALL opportunities if filter is 0 or NULL
        -- 2. Include opportunities with NULL maximum_award
        -- 3. Include opportunities with maximum_award >= filter amount
        (
...
-- Update the total funding available function with the same filter logic
...
-- Update the states with funding count function with the same filter logic
...
-- Update the map-data function with the same filter logic
