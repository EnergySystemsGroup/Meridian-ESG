-- Fix the total funding available function to correctly account for NULL maximum_award values
...
-- Also add a debug function for total funding to help diagnose issues
