-- Migration: Add incentive_structure to funding_opportunities
-- Purpose: Calibration study (23-opportunity review) identified 4-point scoring swing
--          between different incentive structures. Sales team needs this to distinguish
--          prescriptive rebates (quotable $) from opaque programs (apply-and-find-out).
-- Values: prescriptive, deemed_calculated, custom_performance, make_ready,
--         direct_install, financing, audit_assessment, NULL (not applicable)
-- Created: 2026-03-10

-- Step 1: Add the column
ALTER TABLE funding_opportunities
  ADD COLUMN IF NOT EXISTS incentive_structure TEXT;

COMMENT ON COLUMN funding_opportunities.incentive_structure IS
  'How money flows through the program. Values: prescriptive, deemed_calculated, custom_performance, make_ready, direct_install, financing, audit_assessment. NULL = not applicable (most grants).';

-- Step 2: Rebuild the view to include the new column
-- Previous definition: 20260218000002_add_program_id_to_view.sql
...
SELECT
    ...
    fo.review_notes,
    fo.program_id,
    -- New: incentive_structure (calibration study finding, 2026-03-10)
    fo.incentive_structure
