-- Include opportunities with NULL maximum_award in all filter results
...
BEGIN
    ...
    WHERE
        ...
        -- Filter by minimum amount - show opportunities with NULL max award OR with max award >= filter amount
...
-- Update the per-applicant function
