...
// Lazy-loaded default supabase client to avoid environment variable issues
let _supabase = null;
	...
	get(target, prop) {
		if (!_supabase) {
			...
			if (!supabaseUrl || !supabaseKey) {
				throw new Error('Missing Supabase environment variables. Make sure NEXT_PUBLIC_SUPABASE_URL and SUPABASE_SERVICE_ROLE_KEY (or NEXT_PUBLIC_SUPABASE_ANON_KEY) are set.');
			}
