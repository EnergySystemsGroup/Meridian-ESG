...
export const getProjectTypeColor = (projectType) => {
	...
	const projectTypeColors = {
		// HVAC/Air Systems - Sky blue
		'HVAC Systems': { color: '#0EA5E9', bgColor: '#E0F2FE' },
		'Heat Pump Systems': { color: '#0EA5E9', bgColor: '#E0F2FE' },
		'Boiler Systems': { color: '#0EA5E9', bgColor: '#E0F2FE' },
		'Chiller Systems': { color: '#0EA5E9', bgColor: '#E0F2FE' },
		'Building Air Filtration Systems': { color: '#0EA5E9', bgColor: '#E0F2FE' },
		'Refrigeration Systems': { color: '#0EA5E9', bgColor: '#E0F2FE' },
		'Water Heater Systems': { color: '#0EA5E9', bgColor: '#E0F2FE' },

		// Electrical/Lighting - Amber
		'Electrical Systems': { color: '#D97706', bgColor: '#FEF3C7' },
		'EV Charging Stations': { color: '#D97706', bgColor: '#FEF3C7' },
		'Electrical Panel Upgrades': { color: '#D97706', bgColor: '#FEF3C7' },
		'Building Controls': { color: '#D97706', bgColor: '#FEF3C7' },
		'Intercom Systems': { color: '#D97706', bgColor: '#FEF3C7' },
		'Lighting Systems': { color: '#D97706', bgColor: '#FEF3C7' },
		'LED Lighting Upgrades': { color: '#D97706', bgColor: '#FEF3C7' },
		'Street Lighting': { color: '#D97706', bgColor: '#FEF3C7' },

		// Solar/Renewable - Gold
		'Solar Panel Systems': { color: '#F59E0B', bgColor: '#FEF3C7' },
		...
		'Microgrids': { color: '#F59E0B', bgColor: '#FEF3C7' },

		// Power/Storage - Orange
		'Battery Storage Systems': { color: '#EA580C', bgColor: '#FFEDD5' },
		'Emergency Backup Power Systems': { color: '#EA580C', bgColor: '#FFEDD5' },

		// Building Envelope - Brown/tan
		...
		'Siding': { color: '#92400E', bgColor: '#FED7AA' },
		...
		'Drinking Water Infrastructure': { color: '#0284C7', bgColor: '#DBEAFE' },
		'Water Metering Systems': { color: '#0284C7', bgColor: '#DBEAFE' },
		'Water Storage Tanks': { color: '#0284C7', bgColor: '#DBEAFE' },
		'Wastewater Infrastructure': { color: '#0284C7', bgColor: '#DBEAFE' },
		'Sewer Systems': { color: '#0284C7', bgColor: '#DBEAFE' },
		'Stormwater Infrastructure': { color: '#0284C7', bgColor: '#DBEAFE' },
		'Fire Hydrants': { color: '#0284C7', bgColor: '#DBEAFE' },

		// Plumbing - Teal
		'Plumbing Systems': { color: '#0891B2', bgColor: '#CFFAFE' },

		// Facility Types - Indigo
		'Classroom Facilities': { color: '#4F46E5', bgColor: '#E0E7FF' },
		'Kitchen Facilities': { color: '#4F46E5', bgColor: '#E0E7FF' },
		'Gymnasium Facilities': { color: '#4F46E5', bgColor: '#E0E7FF' },
		'Community Center Facilities': { color: '#4F46E5', bgColor: '#E0E7FF' },
		'Library Facilities': { color: '#4F46E5', bgColor: '#E0E7FF' },
		'Healthcare Facilities': { color: '#4F46E5', bgColor: '#E0E7FF' },
		'Student Housing': { color: '#4F46E5', bgColor: '#E0E7FF' },
		'ADA Accessibility Improvements': { color: '#4F46E5', bgColor: '#E0E7FF' },

		// Grounds & Site Work - Green
		...
		'Perimeter Fencing': { color: '#16A34A', bgColor: '#DCFCE7' },
		'Shade Structures': { color: '#16A34A', bgColor: '#DCFCE7' },
		'Landscaping': { color: '#16A34A', bgColor: '#DCFCE7' },
		'Landscape Irrigation Systems': { color: '#16A34A', bgColor: '#DCFCE7' },
		'Recreational Park Facilities': { color: '#16A34A', bgColor: '#DCFCE7' },
		'Urban Greening': { color: '#16A34A', bgColor: '#DCFCE7' },

		// Climate Resilience - Emerald
		'Flood Barriers': { color: '#059669', bgColor: '#D1FAE5' },
		'Heat Resilience Infrastructure': { color: '#059669', bgColor: '#D1FAE5' },
		'Cooling Centers': { color: '#059669', bgColor: '#D1FAE5' },
		'Warming Centers': { color: '#059669', bgColor: '#D1FAE5' },

		// Environmental Remediation - Rose
		'Asbestos Abatement': { color: '#E11D48', bgColor: '#FFE4E6' },
		'Lead Paint Remediation': { color: '#E11D48', bgColor: '#FFE4E6' },
		'Brownfield Remediation': { color: '#E11D48', bgColor: '#FFE4E6' },
		...
		'Ambulances': { color: '#DC2626', bgColor: '#FEE2E2' },
		...
		'Walkways': { color: '#6B7280', bgColor: '#F3F4F6' },
		'Bike Lanes': { color: '#6B7280', bgColor: '#F3F4F6' },
		'Bike Paths': { color: '#6B7280', bgColor: '#F3F4F6' },
		'Parking Lots': { color: '#6B7280', bgColor: '#F3F4F6' },
		'Parking Structures': { color: '#6B7280', bgColor: '#F3F4F6' },
		'Traffic Signals': { color: '#6B7280', bgColor: '#F3F4F6' },
		'Bus Stops': { color: '#6B7280', bgColor: '#F3F4F6' },
		'Bus Shelters': { color: '#6B7280', bgColor: '#F3F4F6' },
		'Rail Infrastructure': { color: '#6B7280', bgColor: '#F3F4F6' },
		'Pedestrian Crossings': { color: '#6B7280', bgColor: '#F3F4F6' },
		'Fleet Vehicles': { color: '#6B7280', bgColor: '#F3F4F6' },
		'Airports': { color: '#6B7280', bgColor: '#F3F4F6' },
		'EV Fleet': { color: '#6B7280', bgColor: '#F3F4F6' },
		'Ports': { color: '#6B7280', bgColor: '#F3F4F6' },
		'Harbors': { color: '#6B7280', bgColor: '#F3F4F6' },

		// Public Safety Facilities - Slate
		'911 Centers': { color: '#475569', bgColor: '#F1F5F9' },
		'Correctional Facilities': { color: '#475569', bgColor: '#F1F5F9' },
		'Dispatch Centers': { color: '#475569', bgColor: '#F1F5F9' },
		'Emergency Operations Centers': { color: '#475569', bgColor: '#F1F5F9' },
		'Fire Stations': { color: '#475569', bgColor: '#F1F5F9' },
		'Police Stations': { color: '#475569', bgColor: '#F1F5F9' },

		// Technology - Purple
		'Data Centers': { color: '#9333EA', bgColor: '#F3E8FF' },
		'Building IT Infrastructure': { color: '#9333EA', bgColor: '#F3E8FF' },

		// Other - Warm gray
		'Kitchen Equipment': { color: '#78716C', bgColor: '#F5F5F4' },
		'Industrial Parks': { color: '#78716C', bgColor: '#F5F5F4' },
		'Elevators': { color: '#78716C', bgColor: '#F5F5F4' },
		'Lifts': { color: '#78716C', bgColor: '#F5F5F4' },
	};
