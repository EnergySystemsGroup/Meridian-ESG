...
export const PROJECT_TYPE_GROUPS = [
	{
		...
		items: [
			'Boiler Systems', 'Building Air Filtration Systems', 'Building Controls',
			'Chiller Systems', 'Electrical Panel Upgrades', 'Electrical Systems',
			'Elevators', 'EV Charging Stations', 'Fire Suppression Systems',
			'Heat Pump Systems', 'HVAC Systems', 'Intercom Systems',
			'LED Lighting Upgrades', 'Lifts', 'Lighting Systems',
			'Plumbing Systems', 'Refrigeration Systems', 'Security Systems',
	...
	},
	{
		...
		items: [
			'Doors', 'Exterior Walls', 'Flooring', 'Foundation Repair',
			'Insulation', 'Roofing', 'Siding', 'Weatherization', 'Windows',
		],
	},
	{
		label: 'Energy & Power',
		items: [
			'Battery Storage Systems', 'Cogeneration Systems',
			'Emergency Backup Power Systems', 'Fuel Cells',
			'Geothermal Systems', 'Microgrids',
			'Solar Panel Systems', 'Wind Turbines',
		],
	},
	{
		label: 'Water Infrastructure',
		items: [
			'Drinking Water Infrastructure', 'Fire Hydrants',
			'Sewer Systems', 'Stormwater Infrastructure',
			'Wastewater Infrastructure', 'Water Metering Systems', 'Water Storage Tanks',
		],
	},
	{
		label: 'Facility Types',
		items: [
			'ADA Accessibility Improvements', 'Classroom Facilities',
			'Community Center Facilities', 'Gymnasium Facilities',
			'Healthcare Facilities', 'Kitchen Facilities',
			'Library Facilities', 'Student Housing',
		],
	},
	{
		label: 'Grounds & Site Work',
		items: [
			'Athletic Courts', 'Athletic Fields', 'Landscape Irrigation Systems',
			'Landscaping', 'Perimeter Fencing', 'Playgrounds',
			'Recreational Park Facilities', 'Shade Structures',
		],
	},
	{
		label: 'Transportation',
		items: [
			'Airports', 'Bike Lanes', 'Bike Paths', 'Bridges',
			'Bus Shelters', 'Bus Stops', 'EV Fleet', 'Fleet Vehicles',
			'Harbors', 'Parking Lots', 'Parking Structures',
			'Pedestrian Crossings', 'Ports', 'Rail Infrastructure',
			'Roads', 'Sidewalks', 'Streets', 'Street Lighting',
			'Traffic Signals', 'Walkways',
		],
	},
	{
		label: 'Public Safety',
		items: [
			'911 Centers', 'Correctional Facilities', 'Dispatch Centers',
	...
	},
	{
		...
		items: [
			'Cooling Centers', 'Flood Barriers', 'Heat Resilience Infrastructure',
			'Urban Greening', 'Warming Centers',
		],
	},
	{
		label: 'Environmental Remediation',
		items: [
			'Asbestos Abatement', 'Brownfield Remediation', 'Lead Paint Remediation',
		],
	},
	{
		label: 'Technology',
		items: [
			'Building IT Infrastructure', 'Data Centers',
		],
	},
	{
		label: 'Other',
		items: [
			'Ambulances', 'Fire Trucks', 'Industrial Parks', 'Kitchen Equipment',
		],
	},
];
