...
/**
 * Get expanded client types for matching (synonyms + hierarchy expansion)
 *
 * Expansion order:
 * 1. Add self
 ...
 *
 * Example: "Municipal Government" expands to:
 * ["Municipal Government", "City Government", "Township Government", "Local Governments"]
 *
...
export const PROJECT_TYPE_GROUPS = [
	...
	},
	{
		...
		items: [
			...
			'Broadband Infrastructure', 'Computers', 'Tablets', 'Software Systems',
			'Laboratory Equipment', 'Kitchen Equipment', 'Office Equipment',
	...
	},
	{
		...
		items: [
			'Classrooms', 'Laboratories', 'Computer Labs', 'Cafeterias', 'Kitchens',
			'Gymnasiums', 'Media Centers', 'Vocational Facilities', 'CTE Facilities',
		],
	},
	{
		...
		items: [
			...
			'Community Centers', 'Libraries', 'Museums', 'Theaters', 'Auditoriums',
