...
const testZodSchema = z.object({
  opportunities: z.array(z.object({
    ...
    incentiveStructure: z.string().nullable().optional(),
    ...
    opportunities: {
      ...
      items: {
        ...
        properties: {
          ...
          incentiveStructure: { type: ["string", "null"], enum: ["prescriptive", "deemed_calculated", "custom_performance", "make_ready", "direct_install", "financing", "audit_assessment", null] },
