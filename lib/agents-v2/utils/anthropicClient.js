...
export class AnthropicClient {
  constructor(config = {}) {
    ...
    this.defaultConfig = {
      model: "claude-sonnet-4-20250514",  // Using Claude Sonnet 4 for enhanced performance
      maxTokens: 64000,  // Sonnet 4's max output capacity
      temperature: 0,
      retries: 4,
        ...
        items: {
          ...
          properties: {
            ...
            applicationSummary: {
              type: "string",
              nullable: false,
              description: "Concise 4-5 sentence summary including: process steps, timeline, key scoring factor, important submissions clients must provide, and success tip. Focus on decision-relevant information."
            },
            programInsights: {
              type: "string",
              nullable: false,
