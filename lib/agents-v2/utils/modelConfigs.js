 ...
 * - Extraction: Haiku 4.5 - fast, cost-efficient for structured data extraction
 * - Analysis: Sonnet 4.5 - higher quality for insights, summaries, and recommendations
 */
...
export const ANTHROPIC_MODELS = {
  ...
  'claude-sonnet-4-5-20250929': {
    ...
    description: 'Most intelligent model - best for coding, agents, and complex reasoning',
  ...
  'claude-haiku-4-5-20251001': {
    ...
    contextWindow: 200000,
    description: 'Fastest, most cost-efficient model - matches Sonnet 4 on coding/agents',
